    ...
    protected function fetch()
    {
        $this->fetch = datatable()->of($this->model)
            ...
            ->addColumn('actions', function ($item) {
                ...
                $disableLink = route('admin::custom-fields.field-group.update-status.post',
                    ['id' => $item->id, 'status' => 'disabled']);
                $activeLink = route('admin::custom-fields.field-group.update-status.post',
                    ['id' => $item->id, 'status' => 'activated']);
